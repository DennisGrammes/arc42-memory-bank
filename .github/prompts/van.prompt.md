...
graph TD
    ...
    %% Rule Loading
    CheckMB_Van --> LoadVan["Load Rule:<br>.github/instructions/rules/isolation_rules/visual-maps/van_mode_split/van-mode-map.md"]
    CheckMB_Plan --> LoadPlan["Load Rule:<br>.github/instructions/rules/isolation_rules/visual-maps/plan-mode-map.md"]
    CheckMB_Creative --> LoadCreative["Load Rule:<br>.github/instructions/rules/isolation_rules/visual-maps/creative-mode-map.md"]
    CheckMB_Impl --> LoadImpl["Load Rule:<br>.github/instructions/rules/isolation_rules/visual-maps/implement-mode-map.md"]
    CheckMB_QA --> LoadQA["Load Rule:<br>.github/instructions/rules/isolation_rules/visual-maps/qa-mode-map.md"]
