...
```mermaid
graph TD
    Start["🚀 START CREATIVE MODE"] --> ReadTasks["📚 Read tasks.md &<br>implementation-plan.md<br>.github/instructions/rules/isolation_rules/main.md"]
    
    %% Initialization
    ReadTasks --> Identify["🔍 Identify Components<br>Requiring Creative Phases<br>.github/instructions/rules/isolation_rules/visual-maps/creative-mode-map.md"]
    ...
    TypeCheck -->|"Architecture"| ArchDesign["🏗️ ARCHITECTURE DESIGN<br>.github/instructions/rules/isolation_rules/visual-maps/creative-mode-map.md"]
    TypeCheck -->|"Algorithm"| AlgoDesign["⚙️ ALGORITHM DESIGN<br>.github/instructions/rules/isolation_rules/visual-maps/creative-mode-map.md"]
    TypeCheck -->|"UI/UX"| UIDesign["🎨 UI/UX DESIGN<br>.github/instructions/rules/isolation_rules/visual-maps/creative-mode-map.md"]
...
```
read_file({
  target_file: ".github/instructions/rules/isolation_rules/visual-maps/creative-mode-map.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/rules/isolation_rules/Core/creative-phase-enforcement.md",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/instructions/rules/isolation_rules/Core/creative-phase-metrics.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/rules/isolation_rules/Phases/CreativePhase/creative-phase-architecture.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/rules/isolation_rules/Phases/CreativePhase/creative-phase-algorithm.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/rules/isolation_rules/Phases/CreativePhase/creative-phase-uiux.md",
  should_read_entire_file: true
})
```
